...
public class Test {
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        WeightedIngredient eggs = new WeightedIngredient("Eggs",1 ,18);
        ...
        WeightedIngredient chocolate = new WeightedIngredient("Chocolate", 100, 1.79);
...
//        System.out.println("friedEggsWithHam " + friedEggsWithHam.getPrice());
        System.out.println(flour.getName() + " --> " + flour.getPrice());
        System.out.println(sugar.getName() + " --> " + sugar.getPrice());
        System.out.println(salt.getName() + " --> " + salt.getPrice());
        System.out.println(yogurt.getName() + " --> " + yogurt.getPrice());
        System.out.println(eggs.getName() + " --> " + eggs.getPrice());
        System.out.println(bakingPowder.getName() + " --> " + bakingPowder.getPrice());
        System.out.println(oil.getName() + " --> " + oil.getPrice());
        ...
        System.out.println(jam.getName() + " --> " +jam.getPrice());
        System.out.println(chocolate.getName() + " --> " +chocolate.getPrice());
        System.out.println(margarine.getName() + " --> " +margarine.getPrice());
        System.out.println(plasmaBiscuit.getName() + " --> " +plasmaBiscuit.getPrice());
        System.out.println(creamCheese.getName() + " --> " +creamCheese.getPrice());
        System.out.println(cream.getName() + " --> " +cream.getPrice());
        System.out.println(raspberries.getName() + " --> " +raspberries.getPrice());

        System.out.println(raspberries.getWeightRecipe());
